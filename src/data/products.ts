...
export const products: Product[] = [
  ...
  {
    id: "tshirt-002", slug: "secoct-graphic-tee", name: "SECOCT Graphic Tee",
    ...
    badge: "HOT",
    description: "Signature SECOCT chest print on premium cotton. The everyday hero of your rotation.",
...

  {
    ...
    badge: "HOT",
    description: "Classic 6-panel trucker with curved brim. Embroidered SECOCT logo.",
  ...
  },
  {
    ...
    description: "Heavy 14oz canvas tote with bold SECOCT print.",
...
export const categoryDescriptions: Record<string, string> = {
  "t-shirts": "Heavyweight tees, oversized cuts and signature graphics. The foundation of every SECOCT fit.",
