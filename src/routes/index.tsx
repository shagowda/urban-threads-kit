    ...
    <div>
      ...
      <section className="relative h-[88vh] min-h-[560px] w-full overflow-hidden">
        ...
        <div className="relative container-x h-full flex flex-col justify-end pb-16 md:pb-24 text-white">
          <span className="font-condensed uppercase tracking-[0.3em] text-sm text-white/80">SECOCT — DROP 01</span>
      ...
      <section className="bg-primary text-primary-foreground py-20 mt-8">
        <div className="container-x grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-white/80 text-base md:text-lg leading-relaxed">
            <p>
              SECOCT was built on one belief — Indian men deserve world-class streetwear without the world-class price tag.
      ...
      <section className="container-x py-16">
        <div className="text-center mb-8">
          ...
          <h2 className="font-display text-4xl md:text-5xl mt-2">@SECOCT</h2>
        </div>
        <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
          {[
            ...
            <a key={id} href="https://instagram.com/secoct" target="_blank" rel="noreferrer" className="block aspect-square overflow-hidden bg-muted">
        ...
        <div className="text-center mt-8">
          <a href="https://instagram.com/secoct" target="_blank" rel="noreferrer" className="btn-outline">Follow on Instagram</a>
        </div>
      </section>
    </div>
  );
